...
void FMODAsset::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::STRING, "path", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_path", "get_path");
    ADD_PROPERTY(
        PropertyInfo(Variant::STRING, "guid", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT),

        "set_guid",
        "get_guid"
    );
    ADD_PROPERTY(PropertyInfo(Variant::STRING, "name", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_name", "get_name");
}
...
void BankAsset::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::STRING, "file_path", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_file_path", "get_file_path");

    ADD_PROPERTY(
        PropertyInfo(Variant::STRING, "modified_time", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_modified_time", "get_modified_time"
    );
}
...
void EventAsset::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("set_event_ref_from_description", "description"), &EventAsset::set_event_ref_from_description_ref);

    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "is_3d", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_3d", "get_3d");
    ADD_PROPERTY(PropertyInfo(Variant::BOOL, "is_oneshot", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_oneshot", "get_oneshot");
    ADD_PROPERTY(
        PropertyInfo(Variant::BOOL, "is_snapshot", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_is_snapshot", "get_is_snapshot"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::FLOAT, "min_distance", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_min_distance", "get_min_distance"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::FLOAT, "max_distance", PropertyHint::PROPERTY_HINT_NONE, "", PROPERTY_USAGE_DEFAULT), "set_max_distance", "get_max_distance"
    );
    ADD_PROPERTY(
        PropertyInfo(Variant::DICTIONARY, "parameters", PropertyHint::PROPERTY_HINT_ARRAY_TYPE, "24/17:ParameterAsset", PROPERTY_USAGE_DEFAULT),
        "set_parameters",
        "get_parameters"
    );
}
            ...
            if (parameter_description.flags & FMOD_STUDIO_PARAMETER_LABELED) {
                ...
                for (int i = 0; i <= maximum; i++) {
                    ...
                    do {
                        ...
                        result = event_description->getParameterLabelByID(parameter_description.id, i, &raw_buffer[0], actual_size, &actual_size);

                        if (result == FMOD_ERR_EVENT_NOTFOUND || result == FMOD_ERR_INVALID_PARAM) {
                            UtilityFunctions::printerr("[FMOD] Failed to get Parameter Label", __FUNCTION__, __FILE__, __LINE__);
                            break;
                        }
...
FMOD::Studio::EventDescription* EventAsset::get_event_description() const {
    ...
    if (studio_system) {
        FMODStudioEditorModule::get_singleton()->get_studio_system()->getEvent(get_path().utf8().get_data(), &event_description);
    }
...
void EventAsset::set_event_ref_from_description_ref(const Ref<StudioApi::EventDescription>& event_description) {
    ...
    for (int i = 0; i < parameter_count; i++) {
        Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> parameter_description = event_description->get_parameter_description_by_index(i);
...
void ParameterAsset::_bind_methods() {
    ClassDB::bind_method(D_METHOD("set_parameter_description", "parameter_description"), &ParameterAsset::set_parameter_description);
    ...
    ADD_PROPERTY(
        PropertyInfo(
            Variant::OBJECT, "parameter_description", PropertyHint::PROPERTY_HINT_RESOURCE_TYPE, "FMOD_STUDIO_PARAMETER_DESCRIPTION", PROPERTY_USAGE_DEFAULT
        ),
...
void ParameterAsset::set_parameter_ref(const FMOD_STUDIO_PARAMETER_DESCRIPTION& parameter_description) {
    ...
    if ((parameter_description.flags & FMOD_STUDIO_PARAMETER_LABELED) && (parameter_description.flags & FMOD_STUDIO_PARAMETER_GLOBAL)) {
        labels.clear();
        int maximum = static_cast<int>(parameter_description.maximum);
        ...
        for (int i = 0; i <= maximum; i++) {
            ...
            do {
                ...
                FMOD::Studio::System* studio_system = FMODStudioEditorModule::get_singleton()->get_studio_system();
                if (studio_system) {
                    result = studio_system->getParameterLabelByID(parameter_description.id, i, &raw_buffer[0], actual_size, &actual_size);
                }
...
void ParameterAsset::set_parameter_description(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION>& parameter_description) {
