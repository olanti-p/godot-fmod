    ...
    if (filter == "") {
        switch (type) {
            case FMODStudioEditorModule::FMODAssetType::FMOD_ASSETTYPE_EVENT: {
                ...
                events_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                events_root->set_meta("Type", "folder");
                snapshots_root = create_item(root_item);
                snapshots_root->set_text(0, "Snapshots");
                snapshots_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                window->search_text->set_placeholder("Search Events...");
                FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_event_tree(), events_root);
                FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_snapshot_tree(), snapshots_root);
            ...
            case FMODStudioEditorModule::FMODAssetType::FMOD_ASSETTYPE_BANK: {
                ...
                banks_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                window->search_text->set_placeholder("Search Banks...");
                FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_bank_tree(), banks_root);
            ...
            case FMODStudioEditorModule::FMODAssetType::FMOD_ASSETTYPE_BUS: {
                ...
                busses_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                window->search_text->set_placeholder("Search Busses...");
                FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_bus_tree(), busses_root);
            ...
            case FMODStudioEditorModule::FMODAssetType::FMOD_ASSETTYPE_VCA: {
                ...
                vcas_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
            ...
            case FMODStudioEditorModule::FMODAssetType::FMOD_ASSETTYPE_GLOBAL_PARAMETER: {
                ...
                parameters_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                window->search_text->set_placeholder("Search Parameters...");
                FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_parameter_tree(), parameters_root);
                ...
                // Setup local parameters
                {
                    ...
                    local_parameters_root->set_icon(0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_FOLDER_CLOSED));
                    FMODStudioEditorModule::get_singleton()->create_tree_items(this, project_cache->get_event_tree(), local_parameters_root);
                                    ...
                                    if (event_asset.is_valid()) {
                                        ...
                                        for (size_t i = 0; i < parameters.size(); i++) {
                                            ...
                                            if (param_asset.is_valid()) {
                                                ...
                                                child->set_icon(
                                                    0, FMODStudioEditorModule::get_singleton()->get_icon(FMODStudioEditorModule::FMOD_ICONTYPE_C_PARAMETER)
                                                );
...
void FMODEditorInspectorProperty::on_button_pressed() {
    ...
    inspector_browser->set_min_size(Vector2(inspector_browser->root_vbox->get_size().x, inspector_browser->root_vbox->get_size().y));
    open_popup();
}
