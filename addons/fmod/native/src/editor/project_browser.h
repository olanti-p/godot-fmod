...
class FMODProjectBrowserWindow : public AcceptDialog {
    ...
    enum PopupType { POPUP_EVENT, POPUP_BANK };

    enum EventPopupItems { EVENT_POPUP_COPY_PATH, EVENT_POPUP_COPY_GUID, EVENT_POPUP_OPEN_IN_STUDIO };

    enum BankPopupItems { BANK_POPUP_COPY_PATH, BANK_POPUP_COPY_GUID, BANK_POPUP_BUILD };
