...
void StudioSystem::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_parameter_description_by_name", "name"), &StudioSystem::get_parameter_description_by_name);
    ClassDB::bind_method(D_METHOD("get_parameter_description_by_id", "parameter_id"), &StudioSystem::get_parameter_description_by_id);
    ClassDB::bind_method(D_METHOD("get_parameter_label_by_name", "name", "label_index"), &StudioSystem::get_parameter_label_by_name);
    ClassDB::bind_method(D_METHOD("get_parameter_label_by_id", "parameter_id", "label_index"), &StudioSystem::get_parameter_label_by_id);
    ClassDB::bind_method(D_METHOD("get_parameter_by_id", "parameter_id"), &StudioSystem::get_parameter_by_id);
    ClassDB::bind_method(D_METHOD("set_parameter_by_id", "parameter_id", "value", "ignore_seek_speed"), &StudioSystem::set_parameter_by_id, DEFVAL(false));
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_id_with_label", "parameter_id", "label", "ignore_seek_speed"), &StudioSystem::set_parameter_by_id_with_label, DEFVAL(false)
    );
    ClassDB::bind_method(
        D_METHOD("set_parameters_by_ids", "parameter_ids", "values", "count", "ignore_seek_speed"), &StudioSystem::set_parameters_by_ids, DEFVAL(false)
    );
    ClassDB::bind_method(D_METHOD("get_parameter_by_name", "name"), &StudioSystem::get_parameter_by_name);
    ClassDB::bind_method(D_METHOD("set_parameter_by_name", "name", "value", "ignore_seek_speed"), &StudioSystem::set_parameter_by_name, DEFVAL(false));
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_name_with_label", "name", "label", "ignore_seek_speed"), &StudioSystem::set_parameter_by_name_with_label, DEFVAL(false)
    );
    ...
    ClassDB::bind_method(D_METHOD("set_listener_attributes", "listener", "attributes", "attenuation_position"), &StudioSystem::set_listener_attributes);
    ...
    ClassDB::bind_method(D_METHOD("load_bank_file", "bank_path", "load_bank_flags", "load_sample_data"), &StudioSystem::load_bank_file);
    ...
    ClassDB::bind_method(D_METHOD("get_parameter_description_list", "capacity"), &StudioSystem::get_parameter_description_list);
...
Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> StudioSystem::get_parameter_description_by_name(const String& name) const {
...
Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> StudioSystem::get_parameter_description_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id
) const {
    Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> ref = create_ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION>();
...
String StudioSystem::get_parameter_label_by_name(const String& name, int label_index) const {
    ...
    do {
        ...
        result = studio_system->getParameterLabelByName(name.utf8().get_data(), label_index, &raw_buffer[0], actual_size, &actual_size);
...
String StudioSystem::get_parameter_label_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, int label_index) const {
    FMOD_STUDIO_PARAMETER_ID id{};
    parameter_id->get_parameter_id(id);
...
bool StudioSystem::set_parameter_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, float value, bool ignore_seek_speed) const {
    FMOD_STUDIO_PARAMETER_ID id{};
    parameter_id->get_parameter_id(id);
...
bool StudioSystem::set_parameter_by_id_with_label(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, const String& label, bool ignore_seek_speed)
    const {
    FMOD_STUDIO_PARAMETER_ID id{};
    parameter_id->get_parameter_id(id);
...
bool StudioSystem::set_parameters_by_ids(const Array& parameter_ids, const Array& values, int count, bool ignore_seek_speed) const {
...
bool StudioSystem::set_parameter_by_name_with_label(const String& name, const String& label, bool ignore_seek_speed) const {
    return ERROR_CHECK(studio_system->setParameterByNameWithLabel(name.utf8().get_data(), label.utf8().get_data(), ignore_seek_speed));
}
...
bool StudioSystem::set_listener_attributes(int listener, Ref<FmodTypes::FMOD_3D_ATTRIBUTES> attributes, const Variant& attenuation_position) const {
...
Ref<Bank> StudioSystem::load_bank_file(const String& bank_path, FMOD_STUDIO_LOAD_BANK_FLAGS load_bank_flags, bool load_sample_data) const {
    FMOD::Studio::Bank* bank = nullptr;
...
TypedArray<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> StudioSystem::get_parameter_description_list(int capacity) const {
    ...
    std::unique_ptr<FMOD_STUDIO_PARAMETER_DESCRIPTION[]> parameter_descriptions = std::make_unique<FMOD_STUDIO_PARAMETER_DESCRIPTION[]>(capacity);

    int parameter_description_count{};
    ERROR_CHECK(studio_system->getParameterDescriptionList(parameter_descriptions.get(), capacity, &parameter_description_count));
...
Ref<CommandReplay> StudioSystem::load_command_replay(const String& file_name, FMOD_STUDIO_COMMANDREPLAY_FLAGS flags) const {
    ...
    if (callable.get_type() == Variant::Type::CALLABLE) {
        if (callable_ptr == nullptr) {
            ...
            return ERROR_CHECK(studio_system->setCallback(
                [](FMOD_STUDIO_SYSTEM* system, FMOD_STUDIO_SYSTEM_CALLBACK_TYPE type, void* commanddata, void* userdata) -> FMOD_RESULT {
...
void StudioSystem::get_cpu_usage(Ref<FmodTypes::FMOD_STUDIO_CPU_USAGE> studio, Ref<FmodTypes::FMOD_CPU_USAGE> core) const {
...
void StudioSystem::get_memory_usage(Ref<FmodTypes::FMOD_STUDIO_MEMORY_USAGE> memory_usage) const {
...
void EventDescription::_bind_methods() {
    ...
    ClassDB::bind_method(D_METHOD("get_parameter_description_count"), &EventDescription::get_parameter_description_count);
    ClassDB::bind_method(D_METHOD("get_parameter_description_by_index", "index"), &EventDescription::get_parameter_description_by_index);
    ClassDB::bind_method(D_METHOD("get_parameter_description_by_name", "name"), &EventDescription::get_parameter_description_by_name);
    ClassDB::bind_method(D_METHOD("get_parameter_description_by_id", "parameter_id"), &EventDescription::get_parameter_description_by_id);
    ClassDB::bind_method(D_METHOD("get_parameter_label_by_index", "index", "label_index"), &EventDescription::get_parameter_label_by_index);
    ClassDB::bind_method(D_METHOD("get_parameter_label_by_name", "name", "label_index"), &EventDescription::get_parameter_label_by_name);
    ClassDB::bind_method(D_METHOD("get_parameter_label_by_id", "parameter_id", "label_index"), &EventDescription::get_parameter_label_by_id);
    ClassDB::bind_method(D_METHOD("get_user_property_count"), &EventDescription::get_user_property_count);
    ClassDB::bind_method(D_METHOD("get_user_property_by_index", "index"), &EventDescription::get_user_property_by_index);
...
Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> EventDescription::get_parameter_description_by_name(const String& name) const {
    Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> ref = create_ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION>();
    FMOD_STUDIO_PARAMETER_DESCRIPTION description{};
...
Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> EventDescription::get_parameter_description_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id
) const {
    Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> ref = create_ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION>();
...
String EventDescription::get_parameter_label_by_index(int index, int label_index) {
    ...
    do {
        raw_buffer.resize(actual_size);
        result = event_description->getParameterLabelByIndex(index, label_index, &raw_buffer[0], actual_size, &actual_size);
...
String EventDescription::get_parameter_label_by_name(const String& name, int label_index) {
    ...
    do {
        raw_buffer.resize(actual_size);
        result = event_description->getParameterLabelByName(name.utf8().get_data(), label_index, &raw_buffer[0], actual_size, &actual_size);
...
String EventDescription::get_parameter_label_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, int label_index) const {
    FMOD_STUDIO_PARAMETER_ID id{};
    id.data1 = parameter_id->get_data1();
    id.data2 = parameter_id->get_data2();
...
TypedArray<EventInstance> EventDescription::get_instance_list(int capacity) {
    ...
    std::unique_ptr<FMOD::Studio::EventInstance*[]> instances = std::make_unique<FMOD::Studio::EventInstance*[]>(capacity);
                ...
                [](FMOD_STUDIO_EVENT_CALLBACK_TYPE type, FMOD_STUDIO_EVENTINSTANCE* event, void* parameters) -> FMOD_RESULT {
                    ...
                    switch (type) {
                        case FMOD_STUDIO_EVENT_CALLBACK_TIMELINE_MARKER: {
                            FMOD_STUDIO_TIMELINE_MARKER_PROPERTIES* properties = static_cast<FMOD_STUDIO_TIMELINE_MARKER_PROPERTIES*>(parameters);
                        ...
                        case FMOD_STUDIO_EVENT_CALLBACK_TIMELINE_BEAT: {
                            FMOD_STUDIO_TIMELINE_BEAT_PROPERTIES* properties = static_cast<FMOD_STUDIO_TIMELINE_BEAT_PROPERTIES*>(parameters);
...
void EventInstance::_bind_methods() {
    ...
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_id", "parameter_id", "parameter_value", "ignore_seek_speed"), &EventInstance::set_parameter_by_id, DEFVAL(false)
    );
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_id_with_label", "parameter_id", "label", "ignore_seek_speed"), &EventInstance::set_parameter_by_id_with_label, DEFVAL(false)
    );
    ClassDB::bind_method(
        D_METHOD("set_parameters_by_ids", "parameter_ids", "values", "count", "ignore_seek_speed"), &EventInstance::set_parameters_by_ids, DEFVAL(false)
    );
    ClassDB::bind_method(D_METHOD("get_parameter_by_name", "name"), &EventInstance::get_parameter_by_name);
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_name", "name", "parameter_value", "ignore_seek_speed"), &EventInstance::set_parameter_by_name, DEFVAL(false)
    );
    ClassDB::bind_method(
        D_METHOD("set_parameter_by_name_with_label", "name", "label", "ignore_seek_speed"), &EventInstance::set_parameter_by_name_with_label, DEFVAL(false)
    );
...
bool EventInstance::set_property(int event_property, float property_value) {
    if (ERROR_CHECK(event_instance->setProperty(static_cast<FMOD_STUDIO_EVENT_PROPERTY>(event_property), property_value))) {
        return true;
    }
...
bool EventInstance::set_parameter_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, float value, bool ignore_seek_speed) const {
    FMOD_STUDIO_PARAMETER_ID id;
    parameter_id->get_parameter_id(id);
...
bool EventInstance::set_parameter_by_id_with_label(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, const String& label, bool ignore_seek_speed)
    const {
    FMOD_STUDIO_PARAMETER_ID id;
    parameter_id->get_parameter_id(id);
...
bool EventInstance::set_parameters_by_ids(const Array ids, const Array values, int count, bool ignore_seek_speed) const {
    ...
    if (ERROR_CHECK(event_instance->setParametersByIDs(parameter_ids.get(), parameter_values.get(), count, ignore_seek_speed))) {
        return true;
    }
...
bool EventInstance::set_parameter_by_name_with_label(const String& name, const String& label, bool ignore_seek_speed) const {
    return ERROR_CHECK(event_instance->setParameterByNameWithLabel(name.utf8().get_data(), label.utf8().get_data(), ignore_seek_speed));
}
...
TypedArray<EventDescription> Bank::get_event_list(int capacity) {
    ...
    std::unique_ptr<FMOD::Studio::EventDescription*[]> descriptions = std::make_unique<FMOD::Studio::EventDescription*[]>(capacity);
