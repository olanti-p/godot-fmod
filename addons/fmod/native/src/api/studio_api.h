...
namespace StudioApi {
    ...
    public:
        ...
        Ref<FmodTypes::FMOD_STUDIO_PARAMETER_DESCRIPTION> get_parameter_description_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id) const;
        ...
        bool set_parameter_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, float value, bool ignore_seek_speed = false) const;
        bool set_parameter_by_id_with_label(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameter_id, const String& label, bool ignore_seek_speed = false)
            const;
        bool set_parameters_by_ids(const Array& parameter_ids, const Array& values, int count, bool ignore_seek_speed = false) const;
        ...
        bool set_listener_attributes(int listener, Ref<FmodTypes::FMOD_3D_ATTRIBUTES> attributes, const Variant& attenuation_position) const;
        float get_listener_weight(int listener) const;
        bool set_listener_weight(int listener, float weight) const;

        Ref<Bank> load_bank_file(const String& bankPath, FMOD_STUDIO_LOAD_BANK_FLAGS load_bank_flags, bool load_sample_data) const;
        ...
        void get_memory_usage(Ref<FmodTypes::FMOD_STUDIO_MEMORY_USAGE> memory_usage) const;
    };
    ...
    public:
        ...
        String get_parameter_label_by_id(const Ref<FmodTypes::FMOD_STUDIO_PARAMETER_ID>& parameterID, int label_index) const;
