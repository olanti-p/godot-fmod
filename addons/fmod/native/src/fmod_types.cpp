...
namespace FmodTypes {
    ...
    void FMOD_STUDIO_PARAMETER_DESCRIPTION::_bind_methods() {
        ...
        ClassDB::bind_method(D_METHOD("set_default_value", "default_value"), &FMOD_STUDIO_PARAMETER_DESCRIPTION::set_default_value);
        ...
        ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "id", PROPERTY_HINT_RESOURCE_TYPE, "FMOD_STUDIO_PARAMETER_ID"), "set_id", "get_id");
        ...
        ADD_PROPERTY(PropertyInfo(Variant::INT, "flags", PROPERTY_HINT_FLAGS, "READONLY, AUTOMATIC, GLOBAL, DISCRETE, LABELED"), "set_flags", "get_flags");
    ...
    void FMOD_STUDIO_PARAMETER_DESCRIPTION::set_parameter_description(const ::FMOD_STUDIO_PARAMETER_DESCRIPTION& parameter_description) {
    ...
    void FMOD_STUDIO_PARAMETER_DESCRIPTION::get_parameter_description(::FMOD_STUDIO_PARAMETER_DESCRIPTION& out_description) const {
    ...
    void FMOD_STUDIO_USER_PROPERTY::_bind_methods() {
        ...
        ADD_PROPERTY(PropertyInfo(Variant::STRING, "name"), "set_name", "get_name");
        ADD_PROPERTY(PropertyInfo(Variant::INT, "type", PROPERTY_HINT_ENUM, "INTEGER,BOOLEAN,FLOAT,STRING"), "set_type", "get_type");
    ...
    void FMOD_STUDIO_BUFFER_USAGE::_bind_methods() {
        ClassDB::bind_method(D_METHOD("set_studio_command_queue", "studio_command_queue"), &FMOD_STUDIO_BUFFER_USAGE::set_studio_command_queue);
        ...
        ADD_PROPERTY(PropertyInfo(Variant::OBJECT, "studio_command_queue"), "set_studio_command_queue", "get_studio_command_queue");
