...
public:
    enum GameEvent { GAMEEVENT_NONE, GAMEEVENT_ENTER_TREE, GAMEEVENT_READY, GAMEEVENT_EXIT_TREE };

    static void to_3d_attributes_node(Ref<FmodTypes::FMOD_3D_ATTRIBUTES> attributes, Object* node, Object* physicsbody);
    static void to_3d_attributes_transform_physicsbody(Ref<FmodTypes::FMOD_3D_ATTRIBUTES> attributes, const Variant& transform, Object* physicsbody);
